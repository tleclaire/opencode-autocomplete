...
async function loadConfig(configPath) {
  ...
  if (ext === "") {
    ...
    const file = files.find((file) => file.startsWith(path2.basename(configPath)) && (file.endsWith(".json") || file.endsWith(".ts") || file.endsWith(".js")));
    if (!file) {
...
//# debugId=22E1DE90AE569C3B64756E2164756E21
