export function createRenderer({ createElement, createTextNode, createDynamicTextNode, createSlotNode, isTextNode, replaceText, insertNode, removeNode, setProperty, getParentNode, getFirstChild, getNextSibling, }: {
    createElement: any;
    createTextNode: any;
    createDynamicTextNode: any;
    createSlotNode: any;
    isTextNode: any;
    replaceText: any;
    insertNode: any;
