...
} ? T : Def extends PrimitiveType ? PrimitiveToTSType<Def> : Def extends "cstring" ? Pointer : Def extends "char*" ? HasLengthOfField<AllFields, FieldName> extends true ? string | null : Pointer : Def extends EnumDef<infer E> ? keyof E : Def extends StructDef<infer OutputType, any> ? OutputType : Def extends ObjectPointerDef<infer T> ? Pointer : Def extends readonly [infer InnerDef] ? InnerDef extends PrimitiveType ? Iterable<PrimitiveToTSType<InnerDef>> : InnerDef extends EnumDef<infer E> ? Iterable<keyof E> : InnerDef extends StructDef<infer OutputType, any> ? Iterable<OutputType> : InnerDef extends ObjectPointerDef<infer T> ? (T | null)[] : never : never;
...
} ? V : StructObjectInputType<Fields>>> & (Fields[number] extends readonly [string, Exclude<PrimitiveType, "pointer">] ? Options extends {
    mapValue: (...args: any[]) => any;
} | {
    default: any;
} | {
    reduceValue: (...args: any[]) => any;
} ? {} : StructListPacking<StructObjectInputType<Fields>> : {}) & (Options extends {
